...
class MoreOptionActivity : BaseActivity() {
    ...
    private val messages = listOf(
        "The Holy Lobster loves you!",
        "The Holy Lobsters love you!",
        "King loves you",
        "Kings love you",
        "Welcome to K7A2",
        ...
        "You can fly?",
        "Yes, you can",
        "Now you love The Potato Lord?",
        "The Potato Lord + Hungry Dino Head?",
        "What about Ninja Duck Version?",
        "Fall in love with Ninja Duck Version?",
        "Watching Ninja Duck Version in new class?",
        "The Potato Lord is not here anymore",
        ...
        "Dancing Hamster Power loves The Holy Lobster?????!!!!!",
        "Or The Potato Lord?",
        "Choose one",
        "The Potato Lord or The Holy Lobster",
        "choose wisely between The Holy Lobster and The Potato Lord",
        "bad dream with The Potato Lord?",
        "bad dream with both",
        "comeback with The Potato Lord in the bed",
        "trying to do something with The Potato Lord",
        "such a bad dream",
        "The Potato Lord is so cute",
        "trying to .... The Potato Lord",
        "bye bye",
        "not so ended at SDK 36",
        "a bad dream about The Potato Lord",
        "such a not so funny time with The Potato Lord",
        "Capture her!",
        "Bye bye The Potato Lord",
        "Have fun with Party Dino Association",
        "It's no fun trying to go to bed with The Potato Lord",
        "Don't do anything bad with The Potato Lord",
        "Welcome to SDK 41",
        "Say goodbye to The Potato Lord for the last time",
        "Banana is a codename for The Potato Lord",
        "Bye bye .... bye bye K7A2.... bye bye The Potato Lord... bye bye all",
